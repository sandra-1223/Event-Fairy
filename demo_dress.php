...
if(isset($_POST['save']))
{
        ...
        $sql_query = "INSERT INTO dress (events, name, phone_number, email, delivery_date, delivery_slot,  message) 
        VALUES ('$events','$name', '$phone_number', '$email',   '$delivery_date', '$delivery_slot', '$message')";

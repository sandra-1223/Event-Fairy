...
if(isset($_POST['save']))
{
        ...
        $sql_query = "INSERT INTO decoration (events, name, phone_number, email, date, slot,  message) 
        VALUES ('$events', '$name', '$phone_number', '$email', '$date', '$slot', '$message')";
